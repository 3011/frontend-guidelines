...
REQUIRED_FILES = {
    ...
    ".github/ISSUE_TEMPLATE/documentation-problem.yml",
    "docs/README.md",
    ...
    "evals/README.md",
    "evals/rubric.md",
    "evals/cases/select-popup-positioning.md",
    "evals/cases/sidebar-tooltip-transition.md",
    "evals/cases/search-input-focus.md",
    "evals/cases/permission-boundary.md",
    "examples/adoption.md",
}
